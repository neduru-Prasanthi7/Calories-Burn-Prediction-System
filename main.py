...
from linear_regression import linear_regressionn
...
if __name__ == '__main__':
    try:
        obj = CALORIES_PREDICTION(f'C:\\Users\\nedur\\Downloads\\Calories_burn_prediction\\calories.csv',
                               f'C:\\Users\\nedur\\Downloads\\Calories_burn_prediction\\calories1.csv')
        obj.var_outli()
     #   obj.fs()
        obj.cat_to_num()
        obj.bal_data()
